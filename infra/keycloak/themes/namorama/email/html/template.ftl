    ...
    <tr>
      <td align="center">
        <table width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width:560px;width:100%;">
          ...
          <!-- Header -->
          <tr>
            <td style="background-color:#0d9a63;border-radius:12px 12px 0 0;padding:24px 32px;text-align:center;">
          ...
          <!-- Card -->
          <tr>
            <td style="background-color:#ffffff;border-left:1px solid #e3e7e5;border-right:1px solid #e3e7e5;padding:32px;">
              <#nested>
            </td>
          </tr>
          ...
          <!-- Footer -->
          <tr>
            <td style="background-color:#fbfcfb;border:1px solid #e3e7e5;border-top:none;border-radius:0 0 12px 12px;padding:20px 32px;text-align:center;">
              <p style="margin:0 0 8px;font-size:12px;color:#8a938f;">
                Vous recevez cet email car un compte Namorama est associé à cette adresse.
              </p>
              <p style="margin:0;font-size:12px;color:#8a938f;">
                <a href="https://namorama.com" style="color:#0d9a63;text-decoration:none;">namorama.com</a>
                &nbsp;·&nbsp;
                <a href="mailto:contact@namorama.com" style="color:#0d9a63;text-decoration:none;">contact@namorama.com</a>
              </p>
            </td>
          </tr>
